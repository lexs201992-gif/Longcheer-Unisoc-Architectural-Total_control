...
.method public addProvider(Lcom/motorola/ccc/http/proxy/provider/HttpProxyProvider;)V
    ...
    iget-object v0, p0, Lcom/motorola/ccc/http/proxy/HttpProxyManager;->providers:Ljava/util/Stack;
...
.method public getProxyHost()Lorg/apache/http/HttpHost;
    ...
    check-cast v2, Lcom/motorola/ccc/http/proxy/provider/HttpProxyProvider;

    invoke-interface {v2}, Lcom/motorola/ccc/http/proxy/provider/HttpProxyProvider;->getProxyHost()Lorg/apache/http/HttpHost;
    ...
    const-string v2, "Did not find proxy host and port"

    invoke-static {v0, v2}, Lcom/motorola/ccc/http/proxy/Logger;->info(Ljava/lang/String;Ljava/lang/String;)V
