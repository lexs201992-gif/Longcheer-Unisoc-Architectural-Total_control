...
.method public constructor <init>(Lcom/motorola/blur/service/blur/ws/MMApiWebService;Lcom/motorola/blur/service/blur/platform/IPlatform;)V
    ...
    invoke-static {p2, v0, p1, v1}, Lcom/motorola/blur/service/blur/BSUtils;->registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;I)V
    ...
    const-string p2, "AppWSProxy created ..."
...
.method private getPayloadFromFile(Ljava/lang/String;)[B
    ...
    const-string v3, "AppWSProxy - bytes read from file: "
    ...
    const-string v2, "AppWSProxy - failed to read message payload from file:"
    ...
    invoke-interface {p0, v0, p1}, Lcom/motorola/blur/service/blur/platform/IPlatform$Logger;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method private handleWSRequest(Lcom/motorola/blur/service/blur/ws/AppWSProxy$requestSource;Ljava/lang/String;Ljava/lang/String;[B)Z
    ...
    :try_start_8
    iget-object v0, v1, Lcom/motorola/blur/service/blur/ws/AppWSProxy;->mLog:Lcom/motorola/blur/service/blur/platform/IPlatform$Logger;

    const-string v2, "CCE:TimeMarkers"

    const-string v4, "Valid request"

    invoke-interface {v0, v2, v4}, Lcom/motorola/blur/service/blur/platform/IPlatform$Logger;->v(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "AppWSProxy - executing web service request: "
    ...
    :try_start_9
    invoke-interface {v0, v4, v2}, Lcom/motorola/blur/service/blur/platform/IPlatform$Logger;->v(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, v1, Lcom/motorola/blur/service/blur/ws/AppWSProxy;->mWebService:Lcom/motorola/blur/service/blur/ws/MMApiWebService;

    invoke-virtual {v0, v3, v1}, Lcom/motorola/blur/service/blur/ws/MMApiWebService;->initiateWebRequest(Lcom/motorola/blur/service/blur/ws/MMApiWSRequest;Lcom/motorola/blur/service/blur/ws/MMApiWebService$WSRequestCallback;)V
    :try_end_9
    ...
    :goto_a
    iget-object v2, v1, Lcom/motorola/blur/service/blur/ws/AppWSProxy;->mLog:Lcom/motorola/blur/service/blur/platform/IPlatform$Logger;

    new-instance v5, Ljava/lang/StringBuilder;

    const-string v6, "AppWSProxy - error processing incoming request: "
    ...
    invoke-interface {v2, v4, v0}, Lcom/motorola/blur/service/blur/platform/IPlatform$Logger;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method private sendAIDLWSResponse(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/motorola/blur/service/blur/ws/AppWSProxy;->mCallbacks:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {p0, p1}, Ljava/util/concurrent/ConcurrentHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/motorola/blur/service/blur/IMMApiWebServiceCallback;

    :try_start_0
    invoke-interface {p0, p2}, Lcom/motorola/blur/service/blur/IMMApiWebServiceCallback;->wsResponse(Ljava/lang/String;)V
    :try_end_0
    ...
    const-string p2, "AppWSProxy - sendAIDLWSResponse() failed!: "
    ...
    invoke-static {p4, p0}, Lcom/motorola/blur/service/blur/Log;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method private sendIntentWSResponse(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/motorola/blur/service/blur/ws/AppWSProxy;->mCtxt:Landroid/content/Context;

    invoke-static {p0, p6}, Lcom/motorola/blur/service/blur/BSUtils;->sendBroadcast(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p0, p6, p1}, Lcom/motorola/blur/service/blur/BSUtils;->sendPrivateBroadcast(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    invoke-static {p0, p6}, Lcom/motorola/blur/service/blur/BSUtils;->sendLocalBroadcast(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public getBinder()Landroid/os/IBinder;
    ...
    iget-object p0, p0, Lcom/motorola/blur/service/blur/ws/AppWSProxy;->mBinder:Lcom/motorola/blur/service/blur/IMMApiWebService$Stub;
...
.method public shutdown()V
    ...
    iget-object p0, p0, Lcom/motorola/blur/service/blur/ws/AppWSProxy;->mRecv:Landroid/content/BroadcastReceiver;
